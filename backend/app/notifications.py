...
@token_required
def get_user_notifications(user_id, user_name):
    """
...
@token_required
def mark_notification_read(user_id, user_name):
  """
...
@token_required
def notify_automation_lead(user_id, user_name):
    """
...
@token_required
def save_file_review(user_id, user_name):
  """
